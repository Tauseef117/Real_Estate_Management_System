...
<table align="center" width="80%" border="1" style="margin-top:10px;">
    ...
    <?php
        $run=mysqli_query($con, $sql="SELECT * FROM property INNER JOIN broker ON property.propid=broker.propid where  type='house'");
       
        if (mysqli_num_rows($run)<1)
        {
            echo "<tr><td colspan='5'>no houses available</td></tr>";
        }
