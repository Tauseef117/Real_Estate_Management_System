...
body {
  ...
  background-repeat:repeat;
    ...
    <?php
        $run=mysqli_query($con, $sql="SELECT * FROM property INNER JOIN broker ON property.propid=broker.propid where  type='apartment'");
       
        if (mysqli_num_rows($run)<1)
        {
            echo "<tr><td colspan='5'>no apartment available</td></tr>";
        }
